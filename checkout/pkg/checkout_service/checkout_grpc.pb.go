...
func (c *checkoutClient) AddToCart(ctx context.Context, in *AddToCartParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *checkoutClient) DeleteFromCart(ctx context.Context, in *DeleteFromCartParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *checkoutClient) ListCart(ctx context.Context, in *ListCartParams, opts ...grpc.CallOption) (*ListCartResponse, error) {
...
func (UnimplementedCheckoutServer) AddToCart(context.Context, *AddToCartParams) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCheckoutServer) DeleteFromCart(context.Context, *DeleteFromCartParams) (*emptypb.Empty, error) {
...
func _Checkout_AddToCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).AddToCart(ctx, req.(*AddToCartParams))
	}
...
func _Checkout_DeleteFromCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).DeleteFromCart(ctx, req.(*DeleteFromCartParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Checkout_ListCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).ListCart(ctx, req.(*ListCartParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Checkout_Purchase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).Purchase(ctx, req.(*PurchaseParams))
	}
	return interceptor(ctx, in, info, handler)
}
