...
func (c *checkoutV1Client) AddToCart(ctx context.Context, in *AddToCartParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *checkoutV1Client) DeleteFromCart(ctx context.Context, in *DeleteFromCartParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *checkoutV1Client) ListCart(ctx context.Context, in *ListCartParams, opts ...grpc.CallOption) (*ListCartResponse, error) {
...
func (c *checkoutV1Client) Purchase(ctx context.Context, in *PurchaseParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedCheckoutV1Server) AddToCart(context.Context, *AddToCartParams) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCheckoutV1Server) DeleteFromCart(context.Context, *DeleteFromCartParams) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteFromCart not implemented")
}
func (UnimplementedCheckoutV1Server) ListCart(context.Context, *ListCartParams) (*ListCartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCart not implemented")
}
func (UnimplementedCheckoutV1Server) Purchase(context.Context, *PurchaseParams) (*emptypb.Empty, error) {
...
func _CheckoutV1_AddToCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutV1Server).AddToCart(ctx, req.(*AddToCartParams))
	}
...
func _CheckoutV1_DeleteFromCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutV1Server).DeleteFromCart(ctx, req.(*DeleteFromCartParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CheckoutV1_ListCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutV1Server).ListCart(ctx, req.(*ListCartParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CheckoutV1_Purchase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutV1Server).Purchase(ctx, req.(*PurchaseParams))
	}
	return interceptor(ctx, in, info, handler)
}
