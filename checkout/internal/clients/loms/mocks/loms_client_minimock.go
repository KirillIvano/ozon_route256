...
//go:generate minimock -i route256/checkout/internal/clients/loms.LomsClient -o ./mocks/loms_client_minimock.go -n LomsClientMock
...
// LomsClientMock implements loms_client.LomsClient
type LomsClientMock struct {
	t minimock.Tester

	funcCreateOrder          func(ctx context.Context, user int64, items []domain.CartItem) (i1 int64, err error)
...
// NewLomsClientMock returns a mock for loms_client.LomsClient
...
func (mmCreateOrder *mLomsClientMockCreateOrder) Expect(ctx context.Context, user int64, items []domain.CartItem) *mLomsClientMockCreateOrder {
...
func (mmCreateOrder *mLomsClientMockCreateOrder) Inspect(f func(ctx context.Context, user int64, items []domain.CartItem)) *mLomsClientMockCreateOrder {
...
func (mmCreateOrder *mLomsClientMockCreateOrder) Set(f func(ctx context.Context, user int64, items []domain.CartItem) (i1 int64, err error)) *LomsClientMock {
	if mmCreateOrder.defaultExpectation != nil {
...
// Then helper
func (mmCreateOrder *mLomsClientMockCreateOrder) When(ctx context.Context, user int64, items []domain.CartItem) *LomsClientMockCreateOrderExpectation {
	if mmCreateOrder.mock.funcCreateOrder != nil {
		mmCreateOrder.mock.t.Fatalf("LomsClientMock.CreateOrder mock is already set by Set")
	}
...
// CreateOrder implements loms_client.LomsClient
func (mmCreateOrder *LomsClientMock) CreateOrder(ctx context.Context, user int64, items []domain.CartItem) (i1 int64, err error) {
...
func (mmStocks *mLomsClientMockStocks) Return(sa1 []domain.Stock, err error) *LomsClientMock {
	if mmStocks.mock.funcStocks != nil {
		mmStocks.mock.t.Fatalf("LomsClientMock.Stocks mock is already set by Set")
	}
...
func (mmStocks *mLomsClientMockStocks) Set(f func(ctx context.Context, sku uint32) (sa1 []domain.Stock, err error)) *LomsClientMock {
	if mmStocks.defaultExpectation != nil {
...
func (e *LomsClientMockStocksExpectation) Then(sa1 []domain.Stock, err error) *LomsClientMock {
	e.results = &LomsClientMockStocksResults{sa1, err}
	return e.mock
}

// Stocks implements loms_client.LomsClient
func (mmStocks *LomsClientMock) Stocks(ctx context.Context, sku uint32) (sa1 []domain.Stock, err error) {
